...
describe('Button', () => {
  describe('disabled states', () => {
    it('hard disabled: sets disabled attribute on native elements', async () => {
      await render(`<button tButton disabled></button>`, {imports: [Button]});
    ...
    it('hard disabled: sets aria-disabled on non-native elements', async () => {
      await render(`<span tButton role="button" disabled></span>`, {imports: [Button]});
    ...
    it('soft disabled (disabledInteractive): removes native disabled and adds aria-disabled', async () => {
      await render(`<button tButton disabled disabledInteractive></button>`, {
        imports: [Button],
      });
      const button = screen.getByRole('button');
    ...
    it('soft disabled: non-native element gets aria-disabled and remains disabledInteractive', async () => {
      await render(`<span tButton role="button" disabled disabledInteractive></span>`, {
        imports: [Button],
      });
      const el = screen.getByRole('button');
      expect(el).not.toHaveAttribute('disabled');
    ...
    it('not disabled: no disabled attributes', async () => {
      await render(`<button tButton></button>`, {imports: [Button]});
      const button = screen.getByRole('button');
      expect(button).not.toHaveAttribute('disabled');
  ...
  describe('tabIndex', () => {
    ...
    it('respects custom tabIndex', async () => {
      await render(`<button tButton [tabIndex]="3"></button>`, {imports: [Button]});
  ...
  it('should set the disabled attribute when disabled', async () => {
    const container = await render(`<button tButton [disabled]="true"></button>`, {
      imports: [Button],
    });
  ...
  it('should not set the disabled attribute when not disabled', async () => {
    const container = await render(`<button tButton></button>`, {imports: [Button]});
  ...
  it('should not set the disabled attribute when not a button', async () => {
    const container = await render(`<a tButton [disabled]="true"></a>`, {
      imports: [Button],
    });
  ...
  it('should update the data-disabled attribute when disabled changes', async () => {
    const {getByRole, rerender, fixture} = await render(
      `<button tButton [disabled]="isDisabled"></button>`,
  ...
  describe('disabled state', () => {
    describe('native button', () => {
      it('should set the disabled attribute when disabled', async () => {
        await render(`<button tButton [disabled]="true">Click me</button>`, {
          imports: [Button],
        });
      ...
      it('should not set the disabled attribute when not disabled', async () => {
        await render(`<button tButton>Click me</button>`, {imports: [Button]});
      ...
      it('should update disabled attribute when disabled changes', async () => {
        const {rerender, fixture} = await render(
          `<button tButton [disabled]="isDisabled">Click me</button>`,
          {imports: [Button], componentProperties: {isDisabled: false}},
        );
    ...
    describe('non-native element', () => {
      it('should not set the disabled attribute on non-button elements', async () => {
        const container = await render(`<a tButton [disabled]="true">Link</a>`, {
          imports: [Button],
        });
      ...
      it('should not set the disabled attribute on div elements', async () => {
        await render(`<div tButton [disabled]="true">Custom</div>`, {imports: [Button]});
  ...
  describe('disabled interactive', () => {
    it('should set data-disabled to soft when disabled and disabledInteractive is true', async () => {
      await render(
        `<button tButton [disabled]="true" [disabledInteractive]="true">Click me</button>`,
        {imports: [Button]},
      );
  ...
  describe('role attribute', () => {
    ...
    it('should add role="button" to non-native elements without explicit role', async () => {
      await render(`<div tButton>Custom Button</div>`, {imports: [Button]});
    ...
    it('should not override explicit role input', async () => {
      await render(`<div tButton [role]="'menuitem'">Menu Item</div>`, {
        imports: [Button],
      });
    ...
    it('should preserve link role for anchors with href', async () => {
      const container = await render(`<a tButton href="/test">Link</a>`, {
        imports: [Button],
      });
    ...
    it('should not add role to input[type="button"]', async () => {
      await render(`<input tButton type="button" value="Input Button" />`, {
        imports: [Button],
      });
    ...
    it('should not add role to input[type="submit"]', async () => {
      await render(`<input tButton type="submit" value="Submit" />`, {
        imports: [Button],
      });
    ...
    it('should not add role to input[type="reset"]', async () => {
      await render(`<input tButton type="reset" value="Reset" />`, {imports: [Button]});
  ...
  describe('with different element types', () => {
    it('should work with button elements', async () => {
      await render(`<button tButton>Button</button>`, {imports: [Button]});
    ...
    it('should work with anchor elements', async () => {
      const container = await render(`<a tButton href="#">Link</a>`, {
        imports: [Button],
      });
    ...
    it('should work with div elements and add role', async () => {
      await render(`<div tButton>Custom</div>`, {imports: [Button]});
    ...
    it('should work with span elements and add role', async () => {
      await render(`<span tButton>Custom</span>`, {imports: [Button]});
  ...
  describe('role attribute handling', () => {
    it('should preserve custom role via input through disabled state changes', async () => {
      const {rerender, fixture} = await render(
        `<div tButton [role]="'tab'" [disabled]="isDisabled">Tab</div>`,
        {imports: [Button], componentProperties: {isDisabled: false}},
      );
    ...
    it('should fall back to auto-assignment when role is null on non-native elements', async () => {
      await render(`<div tButton [attr.role]="null">Custom</div>`, {imports: [Button]});
    ...
    it('should properly handle initial role assignment from attribute', async () => {
      const {rerender, fixture} = await render(`<div tButton [role]="role">Item</div>`, {
        imports: [Button],
  ...
  describe('aria-disabled', () => {
    ...
    it('should update aria-disabled when disabled changes on non-native element', async () => {
      const {rerender, fixture} = await render(
        `<div tButton [disabled]="isDisabled">Custom</div>`,
        {imports: [Button], componentProperties: {isDisabled: false}},
      );
  ...
  describe('input types with native button behavior', () => {
    it('should set disabled attribute on input[type="button"] when disabled', async () => {
      await render(`<input tButton type="button" [disabled]="true" value="Input Button" />`, {
        imports: [Button],
      });
    ...
    it('should set disabled attribute on input[type="submit"] when disabled', async () => {
      await render(`<input tButton type="submit" [disabled]="true" value="Submit" />`, {
        imports: [Button],
      });
    ...
    it('should set disabled attribute on input[type="reset"] when disabled', async () => {
      await render(`<input tButton type="reset" [disabled]="true" value="Reset" />`, {
        imports: [Button],
      });
  ...
  describe('combined disabled and disabledInteractive transitions', () => {
    it('should handle enabling disabledInteractive while already disabled', async () => {
      const {rerender, fixture} = await render(
        `<button tButton [disabled]="true" [disabledInteractive]="isDisabledInteractive">Click me</button>`,
        {imports: [Button], componentProperties: {isDisabledInteractive: false}},
      );
    ...
    it('should handle disabling while disabledInteractive is true', async () => {
      const {rerender, fixture} = await render(
        `<button tButton [disabled]="isDisabled" [disabledInteractive]="true">Click me</button>`,
        {imports: [Button], componentProperties: {isDisabled: false}},
      );
  ...
  describe('anchor elements with href (link buttons)', () => {
    it('should preserve link role on anchor with href', async () => {
      const container = await render(`<a tButton href="/dashboard">Dashboard</a>`, {
        imports: [Button],
      });
    ...
    it('should set data-disabled on anchor with href when disabled', async () => {
      const container = await render(
        `<a tButton href="/dashboard" [disabled]="true">Dashboard</a>`,
        {imports: [Button]},
      );
    ...
    it('should support disabledInteractive on anchor with href', async () => {
      const container = await render(
        `<a tButton href="/dashboard" [disabled]="true" [disabledInteractive]="true">Dashboard</a>`,
        {imports: [Button]},
      );
  ...
  describe('keyboard interactions', () => {
    describe('non-native button', () => {
      it('can be activated with Enter key', async () => {
        ...
        const {fixture} = await render(`<span tButton (click)="onClick($event)">Action</span>`, {
          imports: [Button],
      ...
      it('Space prevents default on keydown to avoid scrolling', async () => {
        await render(`<div tButton>Action</div>`, {imports: [Button]});
    ...
    describe('native button', () => {
      it('does not double-fire click on Enter (native handles it)', async () => {
        const clickSpy = vi.fn();
        await render(`<button tButton (click)="onClick($event)">Click me</button>`, {
          imports: [Button],
          componentProperties: {onClick: clickSpy},
        });
  ...
  describe('disabled prevents interactions', () => {
    it('prevents click events when disabled', async () => {
      const clickSpy = vi.fn();
      await render(`<div tButton [disabled]="true" (click)="onClick($event)">Custom</div>`, {
        imports: [Button],
        componentProperties: {onClick: clickSpy},
      });
    ...
    it('prevents keyboard activation when disabled on non-native element', async () => {
      const clickSpy = vi.fn();
      await render(`<span tButton [disabled]="true" (click)="onClick($event)">Action</span>`, {
        imports: [Button],
        componentProperties: {onClick: clickSpy},
      });
  ...
  describe('disabledInteractive prevents interactions except focus/blur', () => {
    it('allows focus when disabledInteractive', async () => {
      await render(
        `<span tButton role="button" [disabled]="true" [disabledInteractive]="true">Action</span>`,
        {imports: [Button]},
      );
    ...
    it('prevents click when disabledInteractive', async () => {
      const clickSpy = vi.fn();
      await render(
        `<span tButton [disabled]="true" [disabledInteractive]="true" (click)="onClick($event)">Action</span>`,
    ...
    it('allows blur when disabledInteractive', async () => {
      const blurSpy = vi.fn();
      await render(
        `<span tButton [disabled]="true" [disabledInteractive]="true" (blur)="onBlur($event)">Action</span>`,
  ...
  describe('loading state use case', () => {
    it('should maintain tabindex during loading state transitions', async () => {
      const {rerender, fixture} = await render(
        `<button tButton [disabled]="isLoading" [disabledInteractive]="isLoading">
  ...
  describe('Base-UI ported', () => {
    describe('prop: disabled', () => {
      it('native button: uses the disabled attribute and is not disabledInteractive', async () => {
        ...
        await render(`<button tButton disabled (click)="handleClick()"></button>`, {
          imports: [Button],
      ...
      it('custom element: applies aria-disabled and is not disabledInteractive', async () => {
        ...
        await render(`<span tButton disabled (click)="handleClick()"></span>`, {
          imports: [Button],
          componentProperties: {handleClick},
        });
    ...
    describe('prop: disabledInteractive', () => {
      it('native button: prevents click but remains disabledInteractive', async () => {
        ...
        await render(
          `<button tButton disabled disabledInteractive (click)="handleClick()"></button>`,
          {imports: [Button], componentProperties: {handleClick}},
        );
      ...
      it('custom element: prevents click but remains disabledInteractive', async () => {
        ...
        await render(`<span tButton disabled disabledInteractive (click)="handleClick()"></span>`, {
          imports: [Button],
          componentProperties: {handleClick},
        });
      ...
      describe('keyboard interactions', () => {
        ['Enter', 'Space'].forEach((key) => {
          it(`can be activated with ${key} key`, async () => {
            ...
            const {fixture} = await render(`<div tButton (click)="onClick()"></div>`, {
              imports: [Button],
              componentProperties: {onClick: clickSpy},
            });
    ...
    describe('param: tabIndex', () => {
      ...
      it('returns tabIndex when host component is not BUTTON', async () => {
        await render(`<span tButton></span>`, {imports: [Button]});
        const button = screen.getByRole('button');
        expect(button).toHaveProperty('tabIndex', 0);
      });
    ...
    describe('arbitrary props', () => {
      it('passes data attributes to the host element', async () => {
        await render(`<button tButton data-testid="button-test-id"></button>`, {
          imports: [Button],
        });
    ...
    describe('attributes', () => {
      ...
      describe('Host attributes', () => {
        it('should keep the role attribute when it is explicitly set', async () => {
          await render(`<span tButton role="menuitem"></span>`, {imports: [Button]});
          const button = screen.getByRole('menuitem');
          expect(button).toHaveAttribute('role', 'menuitem');
        });

        it('should keep the type attribute when it is explicitly set', async () => {
          await render(`<button tButton type="submit"></button>`, {imports: [Button]});
          const button = screen.getByRole('button');
