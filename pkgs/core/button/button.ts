...
import {on} from '../internal/on';
import {hostAttributes} from '../utils/auto-host';
...
const [provideButtonConfig, injectButtonConfig] = defineCfg<ButtonConfig>(() => {
  const hostAttr = hostAttributes();
  return {
    disabled: false,
